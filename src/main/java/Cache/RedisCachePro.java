 ...
 */
@Component
public class RedisCachePro extends RedisCache {
    ...
    public boolean hmset(String key, Map<String, Object> map) {
        try {
            ...
            logger.error("hmset error:{}", e.getMessage());
            return false;
        }
    }
    ...
    public long sSetAndTime(String key, long time, Object... values) {
        try {
            Long count = redisTemplate.opsForSet().add(key, values.toString());
    ...
    public long sGetSetSize(String key) {
        try {
            ...
            logger.error("sGetSetSize error:{}", e.getMessage());
            return 0;
        }
    }
    ...
    public long setRemove(String key, Object... values) {
        try {
            ...
            logger.error("setRemove error:{}", e.getMessage());
            return 0;
        }
    }
    //===============================list=================================
    ...
    public List<String> lGet(String key, long start, long end) {
        try {
            ...
            logger.error("lGet error:{}", e.getMessage());
            return null;
        }
    }
